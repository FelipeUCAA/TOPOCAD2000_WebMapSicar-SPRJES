...
const databases = [
    {
        url: "https://microcad.blob.core.windows.net/confro2000/sicar/SP.zip",
        localPath: path.join(__dirname, "./layers/SICAR_SP_1.js")
    },
    {
        url: "https://microcad.blob.core.windows.net/confro2000/sicar/RJ.zip",
        localPath: path.join(__dirname, "./layers/SICAR_RJ_2.js")
    },
    {
        url: "https://microcad.blob.core.windows.net/confro2000/sicar/ES.zip",
        localPath: path.join(__dirname, "./layers/SICAR_ES_3.js")
    }
    // {...}
];
